 ...
 * and any walk-booking/van-run-stop rows tied to their bookings or dogs.
 * Irreversible.
 *
 ...
 * additional non-cascading references (AuditLog.actorId,
 * VaccinationRecord.verifiedById, IncidentReport.reportedById) not handled
 * here — there's no path back from STAFF/ADMIN to CUSTOMER in this app, so a
 * genuine customer account should never hit those.
 */
