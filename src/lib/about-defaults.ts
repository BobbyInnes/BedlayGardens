...
export const DEFAULT_ABOUT_STORY =
  "<p>Bedlay Gardens Kennels started as a small, family-run kennels set in the countryside near Glasgow, built on the belief that every dog deserves space to roam, a real walk every day, and staff who know them by name. What began with a handful of kennels has grown into a full boarding, daycare, and dog walking service — without losing the personal touch our regulars have come to rely on.</p>" +
...
export const DEFAULT_ABOUT_FACILITY =
  "<p>Our site sits within enclosed private woodland, giving us the space for secure, escorted forest walks away from roads and livestock. Kennels are sized small, medium, and large, with sharing available for dogs from the same household, heated in winter and well-ventilated in summer.</p>" +
